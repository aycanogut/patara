...
function ReferralConnect() {
  return (
    <Layout meta={{ title: 'Referral Connect' }}>
      <section className="bg-background-default container mx-auto flex max-w-[87.5rem] flex-col gap-4 overflow-x-hidden px-4 pt-5 pb-28 md:px-4 lg:gap-16 2xl:px-0">
