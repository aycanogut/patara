    ...
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          ...
          'z-50 w-[var(--radix-dropdown-menu-trigger-width)] min-w-[8rem] overflow-hidden rounded-lg border p-1 shadow-lg',
          className
        )}
        {...props}
      />
...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        'text-text-primary hover:bg-background-secondary hover:text-text-primary',
        'data-[variant=destructive]:text-red-400 data-[variant=destructive]:hover:bg-red-400/10',
...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn('text-text-secondary px-2 py-1.5 text-sm font-medium data-[inset]:pl-8', className)}
      {...props}
    />
  );
}
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      className={cn(
        'text-text-primary hover:bg-background-secondary hover:text-text-primary',
        'data-[state=open]:bg-background-secondary data-[state=open]:text-text-primary',
